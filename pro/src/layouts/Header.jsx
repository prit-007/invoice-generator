    ...
    <header className="bg-white/80 backdrop-blur-md shadow-sm border-b border-gray-200/50 h-16 flex items-center justify-between px-4 lg:px-6 sticky top-0 z-30">
      ...
      <div className="flex-1 max-w-md mx-4">
        <div className={`relative transition-all duration-300 ${searchFocused ? 'transform scale-105' : ''}`}>
          ...
          />
          <svg className={`absolute left-3 top-3 h-5 w-5 transition-colors duration-300 ${
        ...
        <div className="relative">
          ...
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 17h5l-5-5V9a5 5 0 00-10 0v3l-5 5h5m10 0a1 1 0 01-1 1H9a1 1 0 01-1-1m10 0V9a5 5 0 00-10 0v8" />
            </svg>
            ...
            <div className="absolute right-0 mt-2 w-80 bg-white rounded-xl shadow-lg border border-gray-200 z-50 animate-scale-in">
              ...
              <div className="max-h-64 overflow-y-auto">
                ...
                <div className="p-3 hover:bg-gray-50 transition-colors">
                  <p className="text-sm font-medium text-gray-900">Customer added</p>
