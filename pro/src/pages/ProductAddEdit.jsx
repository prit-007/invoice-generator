          ...
          <h1 className="text-2xl font-bold text-gray-900">
            ...
            <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow">
                <div className="p-6 space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    min="0"
                                    max="100"
                                    className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${errors.tax_rate ? 'border-red-500' : 'border-gray-300'}`}
                                    placeholder="18.00"
                                    aria-invalid={!!errors.tax_rate}
                                />
                                {errors.tax_rate && <p className="mt-1 text-sm text-red-500">{errors.tax_rate}</p>}
                            </div>
                        </div>
                    </div>
                    ...
                    {/* Inventory */}
                    <div>
                        <h2 className="text-lg font-semibold text-gray-900 mb-4">{t('products.inventory')}</h2>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-2">
                                ...
                                <input
                                    ...
                                    onChange={handleInputChange}
                                    min="0"
                                    className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${errors.stock_quantity ? 'border-red-500' : 'border-gray-300'}`}
                                    placeholder="0"
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={handleInputChange}
                                    min="0"
                                    className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${errors.min_stock_level ? 'border-red-500' : 'border-gray-300'}`}
                                    placeholder="0"
                                    aria-invalid={!!errors.min_stock_level}
                                />
                                {errors.min_stock_level && <p className="mt-1 text-sm text-red-500">{errors.min_stock_level}</p>}
                            </div>
                        </div>
                    </div>
